...
const AnswerDeleteButton = async (setCount) => {
  ...
  const questionApi = await ReactionAPI(`https://openmind-api.vercel.app/4-14/subjects/${id}/questions/?limit=1000`, 'GET');
  ...
  setCount((await ReactionAPI(`https://openmind-api.vercel.app/4-14/subjects/${id}/questions/?limit=1000`, 'GET')).count); //새로 만든 api(=delete된데이터)를 가져옴
}
